...
private:
   unsigned int nWindowLength;
   unsigned int nTransformLength;
   unsigned int nSamples;
   unsigned int nPre;
   unsigned int nPost;
   vector<TF_DATA_TYPE>  vWindow;
   vector<TF_DATA_TYPE> vTransformBuffer;
   unique_ptr<FFTParam> hFFT;
};
